...
export default function TaskCard({ task, index, onClick, isSelected }) {
  ...
  return (
    //  Bọc toàn bộ bằng Draggable
    //  draggableId: ID duy nhất của task (phải là String)
    // index: Vị trí của task trong mảng

    <Draggable draggableId={task.id.toString()} index={index}>
      {(provided, snapshot) => (
        <div
          // Các thuộc tính bắt buộc phải gắn vào thẻ div ngoài cùng
          ...
          ${snapshot.isDragging ? 'rotate-2 scale-105 z-50 shadow-2xl' : ''} // Hiệu ứng khi đang kéo
          `}
        >
          <div className="p-4">
