...
export const ResetPassword = () => {
    // PHẦN LOGO VÀ STATE EM TỰ XỬ LÝ NHƯ ĐÃ HỨA NHÉ
    const [email, setEmail] = useState('');
    const [isSubmitted, setIsSubmitted] = useState(false);

    const handleSubmit = (e) => {
        e.preventDefault();
        // [LOGIC TODO]: Xử lý API reset password tại đây
        setIsSubmitted(true);
    };
    ...
    return (
        <div className="min-h-screen bg-[#fcf8ff] flex flex-col items-center justify-center p-6 font-['Inter']">
            ...
            {/* Main Card: Glassmorphism effect with subtle Indigo shadow */}
            <div className="w-full max-w-[440px] bg-white rounded-2xl shadow-[0_20px_50px_rgba(99,102,241,0.08)] border border-indigo-50 p-10 backdrop-blur-xl">
                ...
                {!isSubmitted ? (
                    ...
                    /* Success State - UI theo thiết kế "Check your email" */
            ...
            <p className="mt-10 text-[11px] font-medium text-slate-400 uppercase tracking-widest">
                © 2024 NexTask Inc. Secure Gateway
            </p>
        </div>
    );
};
